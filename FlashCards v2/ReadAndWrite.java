...
public class ReadAndWrite {
	...
	static void writeAllDecks(){
		for(int i = 0; i < DeckOfCards.allDecksOfCards.size(); i++){
			writeDeck(DeckOfCards.allDecksOfCards.get(i));
		}
	}
	...
	static void clearFile(){
		BufferedWriter out;
		try {
			out = new BufferedWriter(new FileWriter("flashcard-decks", false));
			out.close();
		} catch (IOException e) {
